      ...
      <div className="container">
        <div className="row justify-content-center align-items-center">
          ...
          <div className="col-lg-8 col-md-6">
            <div
              className="info-container fs-4 lh-base text-start"
              style={{ fontFamily: "Merriweather, serif" }}
            >
              <p>
                <span className="highlight">Hi! I’m Levan,</span> a full-stack
                developer, journalist, and musician based in Brooklyn, New York.
                I’m passionate about crafting details and bringing clarity to
                everything I do, whether it’s coding, writing, or making music.
                I thrive on creating things that are coherent and
                straightforward. Originally from Tbilisi, Georgia, I moved to
                New York in 2022 to embrace new challenges and continue growing
                in my journey.
              </p>
            </div>
          </div>
